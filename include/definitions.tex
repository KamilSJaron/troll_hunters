...
\newenvironment{card}[2] %   #1 - card type  #2 - image name
    {
        \csname setCard#1\endcsname{#2}
    }
    {
        \newpage
    }
...
\newcommand{\setCardLongNeutral}[1]{
    \gdef\nameX{0.08}
    \gdef\nameY{0.948}
    \gdef\nameBoxsize{0.4}
...
\newcommand{\setCardShortNeutral}[1]{
    \gdef\nameX{0.08}
    \gdef\nameY{0.948}
    \gdef\nameBoxsize{0.4}
